                ...
                <div class="col-xl-6 col-lg-8">
                  ...
                  <span class="cd-words-wrapper">
                      ...
                      @endforeach
                        ...
                        <ul>
                            <li>
                                <a class="common_btn" download="true" href="{{\Illuminate\Support\Facades\Storage::url($infos->resume_file)}}"
                                >{{__('site.download_cv')}} <i class="fa-solid fa-arrow-down-to-line"></i
                                    ></a>
                            </li>
                            <li>
                                <a
